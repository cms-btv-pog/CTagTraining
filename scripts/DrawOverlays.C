...
void DrawROCOverlays(){
  ...
  TString ROC = "ROC_C_B_Inclusive";
  TString ROC_files[] = {"/user/smoortga/CTag/TMVActag_v1/CTaggingCvsB/FullCTaggerSL_CvsB_FloatVariables_NoJetPtEta/histos/AllHistograms.root",
			 "/user/smoortga/CTag/TMVActag_v1/CTaggingCvsB/CMSSW_7_5_1_Retraining/histos/AllHistograms.root"};
			 
  TString LegendNames[] = {"70X",
			   "75X"};
  ...
  l->Draw("same");
  c->Update();
  c->SaveAs(ROC + "_testSL.png"); // + "_Overlay.png");
