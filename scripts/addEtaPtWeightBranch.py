...
def main():
  ...
  outDirName = '/user/smoortga/CTag/TMVActag_v1/FlatTrees_SL_7_5_1_WithNewWeights/QCD'
  histoDirName = '/user/smoortga/CTag/TMVActag_v1/EtaPtWeightHistos_SL_7_5_1/QCD'
